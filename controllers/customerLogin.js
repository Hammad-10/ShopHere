let submitbtn = document.getElementById('submitcustomer');
...
function buttonClickHandler(event) {
    ...
    // Open the object
    xhr.open('POST', '/ptest/ShopHere/models/customerLogin.php', true);
    ...
    xhr.onload = function () {
        if (this.status === 200) {
            ...
            if (response.status === 'success') {
                ...
                window.location.href = '/ptest/ShopHere/index.html';
            } else {
